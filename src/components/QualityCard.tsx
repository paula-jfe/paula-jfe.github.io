...
const QualityCard: React.FC<QualityCardProps> = ({ children, text, ...props }) => {
    return (
        <div
            id="about-quality-card"
            className="text-biloba_flower-900 hover:text-perano-700 transition-colors duration-300"
        >
            <div className="hover:scale-105 transition-transform min-h-120 flex flex-col min-w-[134px] flex-1 items-center justify-center">
                <div>{children}</div>
